...
public class PrinterInformation {
    ...
    PrinterInformation(byte[] data) {
        if (data == null) {
            ...
            this.mFeedLines = 90;
            if (this.mPrinterName.endsWith("IR Mobile Printer") || this.mPrinterName.endsWith("IR Mobile Printer")
                    || this.mPrinterName.endsWith("DATECS Ltd.") || this.mPrinterName.endsWith("CMP-10BT")
                    || this.mPrinterName.endsWith("CMP-10") || this.mPrinterName.endsWith("CMP-10 Bluetooth")
                    || this.mPrinterName.endsWith("CITIZEN SYSTEMS")) {
                this.mPrinter = 0;
                this.mMaxPageWidth = 384;
                this.mFeedLines = 90;
            }

            if (this.mPrinterName.endsWith("DPP-350") || this.mPrinterName.endsWith("DPP350")
                    || this.mPrinterName.endsWith("BLM-80") || this.mPrinterName.endsWith("BLM-80C")
                    || this.mPrinterName.endsWith("DPP-350C")) {
                this.mPrinter = 1;
                if ((data[30] & 64) != 0) {
            ...
            if (this.mPrinterName.endsWith("DPP-250") || this.mPrinterName.endsWith("SM1-21")
                    || this.mPrinterName.endsWith("SM1-22") || this.mPrinterName.endsWith("DPP-255")
                    || this.mPrinterName.endsWith("DPP-250C")) {
                this.mPrinter = 2;
                this.mMaxPageWidth = 384;
                this.mFeedLines = 110;
                if (this.mBlackmarkSupported) {
            ...
            if (this.mPrinterName.endsWith("DPP450") || this.mPrinterName.endsWith("DPP-450")
                    || this.mPrinterName.endsWith("SM2-41")) {
                this.mPrinter = 5;
